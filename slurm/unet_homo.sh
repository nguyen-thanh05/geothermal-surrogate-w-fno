...
#SBATCH --output=/home/thanh2/projects/def-juliana2/thanh2/master-research/AR_FNO/logs/unet_baseline_onestep_%j.out
...
python training/train.py --config configs/unet_homo.yml --hpc true --seed 42
